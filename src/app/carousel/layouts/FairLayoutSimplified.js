...
const FairLayout = ({ slide }) => {
  ...
  return (
    <div className={styles.embla__slide__inner} style={{height: '70vh'}}>
      ...
      <Link href={`/fairs/${slide.slug}`} style={{margin: '0px', padding: '0px', width: '100vw'}}>
        <Image
